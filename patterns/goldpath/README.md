...
**Default UI:** repo-root [`DESIGN.md`](../../DESIGN.md) (fleet + jobs board) + [`.cursor/rules/follow-devscrolls-ui-foundation.mdc`](../../.cursor/rules/follow-devscrolls-ui-foundation.mdc).
