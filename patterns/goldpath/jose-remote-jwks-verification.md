...
- **Date:** 2026-05-13  
- **Source:** [docs/jose-for-agents.md](../../docs/jose-for-agents.md); canonical Worker example in sibling package [`../../../matrix/src/access.js`](../../../matrix/src/access.js)  
...
- **When to use:** Adding JWT or OIDC verification in this worker; mirror Matrix’s Access flow if using Cloudflare Access headers.
