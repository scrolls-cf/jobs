...
- **Fix / reference** — Prefer [`../goldpath/workers-builds-ci-deploy-command.md`](../goldpath/workers-builds-ci-deploy-command.md); keep package-specific notes in [`../../docs/cloudflare-workers-for-agents.md`](../../docs/cloudflare-workers-for-agents.md) when present. The **scrollsmatrix** package mirrors this anti-pattern under the same filename in its `patterns/errors/` tree.
