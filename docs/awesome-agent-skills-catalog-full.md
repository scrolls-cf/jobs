...
> **Project mirror for agents:** Search this file (1100+ linked skills). Canonical upstream: https://github.com/VoltAgent/awesome-agent-skills/blob/main/README.md — refresh: `curl -sL https://raw.githubusercontent.com/VoltAgent/awesome-agent-skills/main/README.md -o docs/awesome-agent-skills-catalog-full.md`
